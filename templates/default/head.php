...
<head>
    ...
    <link href="public/css/legacy.css" rel="stylesheet" type="text/css">
    <?php if ($shouldIncludeBrowsePageCss) { ?>
        <link href="public/css/pages/browse.css" rel="stylesheet" type="text/css">
    <?php } ?>
