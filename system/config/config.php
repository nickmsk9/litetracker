...
'reCaptcha' => $ltCaptchaEnabled , //Совместимость со старым ключом
'reCaptcha_publickey' => '' , //Совместимость со старым ключом
'reCaptcha_privatekey' => '' , //Совместимость со старым ключом
