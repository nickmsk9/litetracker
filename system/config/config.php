...
//Система бонусов
// бонусы начисляются за активное присутствие на сайте; за 1 час пользователь получает {voice_price} бонусов
'voice_price' => 100 , //Количество бонусов, получаемых пользователем за час
